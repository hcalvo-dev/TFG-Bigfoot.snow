    ...
    <section className="w-full py-14 px-6 max-w-6xl mx-auto">
      ...
      >
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-18 uppercase text-gray-500 font-semibold tracking-wider">Cookies esenciales</span>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-18 uppercase text-gray-500 font-semibold tracking-wider">Cookies analíticas</span>
          <p className=" text-gray-500 max-w-xs">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-18 uppercase text-gray-500 font-semibold tracking-wider">Cookies de preferencia</span>
          <p className=" text-gray-500 max-w-xs">

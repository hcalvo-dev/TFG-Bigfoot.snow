...
console.log('Tiendas:', tiendasData);
  ...
  const productosFiltrados = productos
    ...
    .filter((p) => (filtroCategoria ? p.categoria?.nombre === filtroCategoria : true))
    ...
    .filter(() => (filtroTienda ? true : true)); // Puedes implementar por tienda si aplica
          ...
          <tbody>
            {productosPaginados.map((p) => (
              <tr
                ...
                <td className="p-3">€{p.precioDia.toFixed(2)}</td>
                <td className="p-3">{p.stockTotal}</td>
                ...
                <td className="p-3 space-x-2">
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-xs shadow shadow-black/40">
                    Editar
                  </button>
                  <button
                    onClick={() => handleDelete(p.id)}
                    className="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-xs shadow shadow-black/40">
                    Eliminar
                  </button>
                </td>
              </tr>
      ...
      {modalProducto && (
        <div
          ...
          <div
            ...
            <FormularioProducto
              producto={modalProducto.id ? modalProducto : undefined}
